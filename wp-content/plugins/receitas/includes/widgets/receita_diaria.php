<?php
class Ar_receita_Do_Dia_Widget extends WP_Widget {

  public function __construct() {
    $options = array(
      'description' => 'Mostra uma receita nova por dia'
    );
    parent::__construct('ar_receita_do_dia', 'Receita Do Dia', $options);
  }
  ...
  public function form($instance) {
    ...
    <p>
      ...
      <input type="text" class="widefat" id="<?php echo $title_id; ?>" name="<?php echo $title_name; ?>" value="<?php $title_value; ?>" />
    </p>
    <?php
  }
