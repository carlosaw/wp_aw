<section>
  <div class="banner">
    <div class="container">
      <div class="col-sm-5">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/heroimage.png" class="hero-image" />
      </div>
      <div class="col-sm-7">
        <h2>Esse <strong>Blog</strong> é para você que quer <strong>aprender a programar do zero</strong> em pouco tempo!</h2>
        <div class="optin">
          Se você quer receber <strong>conteúdos exclusivos</strong><br/> que eu só mando por e-mail, cadastre-se na lista VIP:

          <form method="POST" action="https://b7web428.activehosted.com/proc.php">
